...
const LeadIcon = () => (
    <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 19v-8.93a2 2 0 01.89-1.664l7-4.666a2 2 0 012.22 0l7 4.666A2 2 0 0121 10.07V19M3 19a2 2 0 002 2h14a2 2 0 002-2M3 19h18M12 14a2 2 0 110-4 2 2 0 010 4z" /></svg>
);

const HeroIcon = () => (
    <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 4v5h5M5.75 9.75L4 8V4h4l1.75 1.75M20 4v5h-5M18.25 9.75L20 8V4h-4l-1.75 1.75M4 20v-5h5M5.75 14.25L4 16v4h4l1.75-1.75M20 20v-5h-5M18.25 14.25L20 16v4h-4l-1.75-1.75" /></svg>
);
...
const IndexingIcon = () => (
    <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2h1a2 2 0 002-2v-1a2 2 0 012-2h1.945M7.7 9.77l.093.093a2 2 0 002.828 0l.093-.093m-4.439 4.44l.093.093a2 2 0 002.828 0l.093-.093m4.439-4.44l.093.093a2 2 0 002.828 0l.093-.093M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
);
...
const FilmIcon = () => (
    <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 4v16M17 4v16M3 8h4m10 0h4M3 12h18M3 16h4m10 0h4M4 4h16a1 1 0 011 1v14a1 1 0 01-1 1H4a1 1 0 01-1-1V5a1 1 0 011-1z" /></svg>
);
...
const ShieldCheckIcon = () => (
    <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 20.944A12.02 12.02 0 0012 23v-4.057a8.528 8.528 0 01-3.13-1.636l-1.07-1.07m5.207-5.207l-1.07-1.07a8.528 8.528 0 01-1.636-3.13V4.528A12.02 12.02 0 0012 3z" /></svg>
);


export const NAV_ITEMS = [
    { name: 'Dashboard', icon: <DashboardIcon /> },
    { name: 'SEO Optimizer', icon: <SeoIcon /> },
    { name: 'Keyword Research', icon: <KeywordIcon /> },
    { name: 'Competitor Analysis', icon: <CompetitorIcon /> },
    { name: 'Local SEO', icon: <LocalSeoIcon /> },
    { name: 'Analytics Report', icon: <AnalyticsIcon /> },
    { name: 'Marketing Personas', icon: <PersonaIcon /> },
    { name: 'A/B Testing Ideas', icon: <AbTestIcon /> },
    { name: 'Indexing Tools', icon: <IndexingIcon /> },
    { name: 'Event Theme Ideator', icon: <LightbulbIcon /> },
    { name: 'Internal Linker', icon: <LinkIcon /> },
    { name: 'Content Creator', icon: <ContentCreatorIcon /> },
    { name: 'Blog Manager', icon: <BlogIcon /> },
    { name: 'Social Media Post', icon: <SocialMediaIcon /> },
    { name: 'Ad Copy Generator', icon: <AdIcon /> },
    { name: 'FAQ Generator', icon: <FaqIcon /> },
    { name: 'Video Script Generator', icon: <VideoScriptIcon /> },
    { name: 'Video Generator', icon: <FilmIcon /> },
    { name: 'Press Release Generator', icon: <PressReleaseIcon /> },
    { name: 'Email Campaign Generator', icon: <EmailIcon /> },
    { name: 'Brand Kit', icon: <BrandKitIcon /> },
    { name: 'Hero Section', icon: <HeroIcon /> },
    { name: 'Services', icon: <ServicesIcon /> },
    { name: 'Gallery', icon: <GalleryIcon /> },
    { name: 'Testimonials', icon: <TestimonialsIcon /> },
    { name: 'Lead Manager', icon: <LeadIcon /> },
    { name: 'Pages', icon: <PageIcon /> },
    { name: 'Site Settings', icon: <SettingsIcon /> },
    { name: 'API Key Tester', icon: <ShieldCheckIcon /> },
];
