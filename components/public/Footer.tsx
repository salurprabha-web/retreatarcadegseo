    ...
    <footer className="bg-brand-dark border-t border-gray-800">
      <div className="container mx-auto px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 text-center md:text-left">
          ...
          <div className="md:col-span-1">
            <a href="#/" className="inline-block mb-4 text-left">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
                ...
                <li><a href="#/?scrollTo=gallery" className="hover:text-brand-accent">Gallery</a></li>
                <li><a href="#/blog" className="hover:text-brand-accent">Blog</a></li>
                <li><a href="#/?scrollTo=contact" className="hover:text-brand-accent">Contact</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
                ...
                <li><a href="#/terms" className="hover:text-brand-accent">Terms of Service</a></li>
      ...
      <div className="bg-black/20 py-4">
          <div className="container mx-auto px-6 text-center text-sm text-gray-500 md:flex justify-between items-center">
            ...
            <a href="#/login" className="text-xs hover:text-brand-accent transition-colors mt-2 md:mt-0 inline-block">Admin Login</a>
          </div>
      </div>
    </footer>
  );
